...
public class Queries extends AppCompatActivity implements View.OnClickListener{
    ...
    String Name, UName, Address, Phone, Region, diseas, symptomps, promblem,clinic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etpromblem = (EditText) findViewById(R.id.etpromblem);
    ...
    public void getData()
    {
        ...
        promblem=etpromblem.getText().toString().trim();
       ...
       // params1.add(new BasicNameValuePair("diseas", diseas));
        params1.add(new BasicNameValuePair("problem", promblem));
        params1.add(new BasicNameValuePair("phone", Phone));
        params1.add(new BasicNameValuePair("region", Region));


        json = HttpCommunication.makeHttpRequest(Constant.TEMP_QUERIES_UPDATE, "GET", params1,getApplicationContext());
        try {
