...
public class DieasesMenu extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dieases_menu);
    ...
    public void getData()
    {
       ...
       // Mail=etadd.getText().toString().trim();
        ...
        json = HttpCommunication.makeHttpRequest(Constant.TEMP_DISEAS_UPDATE, "GET", params1,getApplicationContext());
        try {
